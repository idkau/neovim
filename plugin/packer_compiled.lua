...
_G.packer_plugins = {
  ["beacon.nvim"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/beacon.nvim",
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["gv.vim"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/gv.vim",
    url = "https://github.com/junegunn/gv.vim"
  },
  indentLine = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/indentLine",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  tagbar = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/tagbar",
  ...
  ["vim-vsnip-integ"] = {
    loaded = true,
    path = "/home/jason/.local/share/nvim/site/pack/packer/start/vim-vsnip-integ",
